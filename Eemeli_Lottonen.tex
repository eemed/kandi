...
\newcommand*{\Kuukausi}{\ifcase\ \month\ \or\ Tammi\or\ Helmi\or\ Maalis\or\ Huhti\or\ Touko\or\ Kesä\or\ Heinä\or\ Elo\or\ Syys\or\ Loka\or\ Marras\or\ Joulu\fi kuu}
    ...
    \begin{proof}\cite[s.~492]{PA}\label{tod: Hamming}
        \begin{enumerate}
            \item Tämä seuraa suoraan määritelmän \hyperref[maar:perus]{\ref{maar:perus}} kohdista~\ref{kht:etaisyys} ja~\ref{kht:paino}.
            ...
            \item Tämä seuraa suoraan määritelmän \hyperref[maar:perus]{\ref{maar:perus}} kohdasta~\ref{kht:etaisyys}.
            ...
            \item Olkoon $x = u - v$ ja $y = v - w$. Nyt lauseen~\ref{lause:Hamming} kohdan~\ref{kht:etaisyyspaino} nojalla epäyhtälön vasemmasta puolesta saadaan
                ...
                \[
                    wt\left(x + y\right) = \sum_{1 \le i \le n} z_i \qquad wt\left(x\right) = \sum_{1 \le i \le n} x_i \qquad wt\left(y\right) = \sum_{1 \le i \le n} y_i \text{.}
                \]
