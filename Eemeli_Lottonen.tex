...
\newcommand*{\Kuukausi}{\ifcase\month\or{}Tammi\or{}Helmi\or{}Maalis\or{}Huhti\or{}Touko\or{}Kesä\or{}Heinä\or{}Elo\or{}Syys\or{}Loka\or{}Marras\or{}Joulu\fi kuu}
    ...
    Olkoon $C$ $(n,k)$-koodi. Nyt vektoriavaruus $\Zset_2^n$ on abelin ryhmä yhteenlaskun suhteen, sillä vektoriavaruuden aksioomiin sisältyy kaikki abelinryhmän aksioomat. Vektoriavaruuden $\Zset_2^n$ mahtavuus on $2^n$. Nyt koodi $C$ on vektoriavaruuden $\Zset_2^n$ aliryhmä yhteenlaskun suhteen ja sen mahtavuus on $2^k$. Koodilla $C$ on nyt $\frac{2^n}{2^k} = 2^{n-k}$ sivuluokkaa.
    \begin{esimerkki}
    \end{esimerkki}
